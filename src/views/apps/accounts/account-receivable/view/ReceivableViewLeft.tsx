...
const ReceivableViewLeft = ({ companyData }: { companyData: any }) => {
  ...
  // const {
  //   attributes: { client, invoice }
  // } = companyData

  // const clientDetails = client.data.attributes
  // const invoiceId = invoice.data.id

  // console.log('ivID===', invoiceId)
...
export default ReceivableViewLeft
