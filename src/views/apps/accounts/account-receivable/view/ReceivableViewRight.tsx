...
const ReceivableViewRight = ({ invoiceData, transactionData }: Props) => {
  console.log('zdata', transactionData)
  const [value, setValue] = useState('invoice') // State for active tab
    ...
    <TabContext value={value}>
      <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
        <TabList onChange={handleChange} aria-label='account details tabs'>
          <Tab value='invoice' label='Invoice' icon={<Icon icon='mdi:clipboard-outline' />} />
...
export default ReceivableViewRight
