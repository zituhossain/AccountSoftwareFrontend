...
const ReceivePayment = ({
    ...
    ;(async () => {
      if (paymentId !== null) {
        try {
          ...
          setSelectedInvoice(response.data.attributes.invoice.data)
          setAccountHeader(response.data.attributes.debit_account.data.id)
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      ...
      toast.success('Receive Amount successfully')
